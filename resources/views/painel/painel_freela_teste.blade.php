...
<head>
    ...
    <style>
        ...
        /* ---- CSS do Feed de Projetos (integrado) ---- */
...
<main class="flex-1 w-full ml-0 md:ml-[280px] max-w-[calc(1440px-280px)] mx-auto flex flex-col min-h-screen">
    ...
    <div class="flex-1 p-container-padding-mobile md:p-container-padding-desktop flex flex-col gap-8 pb-20">
        ...
        <section id="spa-view" class="bg-[#CCFF00]">
            ...
            <!-- VIEW: INÍCIO (conteúdo existente) -->
            <div id="view-inicio">
                <!-- Page Header -->
...
<script>
    (function () {
        ...
        // Template do Início (já existente no HTML)
        const templates = {
            inicio: document.getElementById('view-inicio')?.outerHTML || ''
        };

        // Template do Feed de Trabalhos (com botões "Ver job" marcados)
        templates.trabalhos = `
            <div id="view-trabalhos" class="min-h-screen relative z-10 flex flex-col pb-20">
                ...
                <header class="w-full px-4 md:px-10 pt-8 pb-6 sticky top-0 md:top-0 z-30 bg-[#CCFF00] shadow-sm">
                    <div class="max-w-[1280px] mx-auto">
                        ...
                        <div class="flex overflow-x-auto gap-3 pb-2 scrollbar-hide no-scrollbar">
                            ...
                            <button class="px-5 py-2 rounded-full bg-white text-black font-medium whitespace-nowrap hover:bg-gray-100 transition-colors shadow-sm">Vídeo</button>
                ...
                <div class="max-w-[1280px] mx-auto w-full px-4 md:px-10 flex flex-col lg:flex-row gap-6 mt-4">
                    ...
                    <!-- Left Column: Advanced Filters (25%) -->
                        ...
                        <div class="bg-white rounded-2xl p-6 shadow-xl text-black">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="flex justify-between mt-2 text-[12px] leading-[16px] text-gray-600">
                                    <span>10K</span>
                                    <span class="font-bold text-black">Até 250K</span>
                                    <span>500K+</span>
                                </div>
                            </div>
                    ...
                    <section class="w-full lg:w-3/4 flex flex-col gap-5">
                        ...
                        <article class="bg-white rounded-2xl p-6 shadow-xl border-l-8 border-l-[#FF5722] relative group transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl text-black">
                            ...
                            <div class="flex flex-wrap gap-2 mb-6">
                                ...
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">Design Systems</span>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                                ...
                                <div class="flex items-center gap-4 w-full md:w-auto">
                                    ...
                                    <button data-open-job class="flex-1 md:flex-none border-2 border-black text-black px-6 py-2 rounded-xl font-bold hover:bg-black hover:text-white transition-colors">
                                        Ver job
                                    </button>
                                </div>
                            </div>
                        ...
                        <article class="bg-white rounded-2xl p-6 shadow-md border border-gray-100 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl text-black">
                            ...
                            <div class="flex flex-wrap items-center gap-4 text-[12px] leading-[16px] text-gray-600 mb-4">
                                ...
                                <div class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">work</span> Projeto Rápido</div>
                                <div class="flex items-center gap-1 text-gray-400"><span class="material-symbols-outlined text-[16px]">gpp_maybe</span> Pagamento Não Verificado</div>
                            </div>

                            <p class="text-[16px] leading-[24px] text-gray-700 mb-6 line-clamp-2">
                                Preciso de um desenvolvedor front-end para criar uma landing page simples para um evento, baseada num design no Figma que já está pronto. A página precisa ser responsiva e ter um formulário de contacto simples integrado com Mailchimp.
                            </p>

                            <div class="flex flex-wrap gap-2 mb-6">
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">React</span>
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">Next.js</span>
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">Tailwind CSS</span>
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">HTML/CSS</span>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-bold text-[18px] leading-[28px]">
                                        M
                                    </div>
                                    <div>
                                        <p class="text-[14px] leading-[20px] font-medium font-bold">Miguel Santos</p>
                                        <div class="flex items-center gap-1 text-gray-400">
                                            <span class="text-[12px] leading-[16px]">Cliente Novo</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-4 w-full md:w-auto">
                                    <div class="text-right hidden md:block">
                                        ...
                                        <p class="text-[12px] leading-[16px] text-gray-500">Publicado há 5h</p>
                                    </div>
                                    <button data-open-job class="flex-1 md:flex-none border-2 border-black text-black px-6 py-2 rounded-xl font-bold hover:bg-black hover:text-white transition-colors">
                                        Ver job
                                    </button>
                        ...
                        <article class="bg-white rounded-2xl p-6 shadow-md border border-gray-100 transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl text-black">
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
                                <h3 class="text-[24px] leading-[32px] font-semibold leading-tight hover:text-blue-600 transition-colors cursor-pointer">Edição de Vídeo para Campanhas TikTok/Reels</h3>
                                <div class="bg-gray-50 px-4 py-2 rounded-lg border border-gray-100 shrink-0">
                                    <span class="text-[24px] leading-[32px] font-semibold font-bold block">15.000 Kz / hora</span>
                                    <span class="text-[12px] leading-[16px] text-gray-500 uppercase tracking-wide">Estimativa: 20h/mês</span>
                                </div>
                            </div>

                            <div class="flex flex-wrap items-center gap-4 text-[12px] leading-[16px] text-gray-600 mb-4">
                                <div class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">location_on</span> Remoto</div>
                                <div class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">schedule</span> Contínuo</div>
                                <div class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">work</span> Part-time</div>
                                <div class="flex items-center gap-1 text-green-600"><span class="material-symbols-outlined text-[16px]">verified</span> Pagamento Verificado</div>
                            </div>

                            <p class="text-[16px] leading-[24px] text-gray-700 mb-6 line-clamp-2">
                                Agência de marketing procura editor de vídeo dinâmico para produzir criativos de formato curto (Reels/TikTok) para marcas de retalho. O material bruto será fornecido. Procuramos estilo moderno, com legendas animadas e cortes rápidos.
                            </p>

                            <div class="flex flex-wrap gap-2 mb-6">
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">Premiere Pro</span>
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">After Effects</span>
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">TikTok Trends</span>
                                <span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-md text-[12px] leading-[16px] border border-gray-200">CapCut</span>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                                <div class="flex items-center gap-3">
                                    <img alt="Client Avatar" class="w-10 h-10 rounded-full"
                                         src="https://lh3.googleusercontent.com/aida-public/AB6AXuAjH7LZoaD0QkGMyJYpFdfEZwNiHML3ESznBUAKv9ofh90sAsWn0FHDDq6U2j7R7UlZn8_0Uptik_yoztUyD1bgz8ztVbuCbw_VVqEwGKDYey77Pi0LQ2Q8jTI_De4eBE1dTLy30wl4OWgef4c7ZRLSX2e8YMTkzeX0Cn_CGOm2rBRClj02oF5uaWBIR1P-az4aITheoNsDvBoakWXJdIp9DHaJYOK0zvmEFn5a5f3SrGU-L9aRvKD77yPqR3QsEu-JYPuCvy2KyKs"/>
                                    <div>
                                        <p class="text-[14px] leading-[20px] font-medium font-bold">Agência Boost</p>
                                        <div class="flex items-center gap-1 text-[#FF5722]">
                                            <span class="material-symbols-outlined text-[14px]" style="font-variation-settings: 'FILL' 1;">star</span>
                                            <span class="material-symbols-outlined text-[14px]" style="font-variation-settings: 'FILL' 1;">star</span>
                                            <span class="material-symbols-outlined text-[14px]" style="font-variation-settings: 'FILL' 1;">star</span>
                                            <span class="material-symbols-outlined text-[14px]" style="font-variation-settings: 'FILL' 1;">star</span>
                                            <span class="material-symbols-outlined text-[14px]" style="font-variation-settings: 'FILL' 1;">star</span>
                                            <span class="text-[12px] leading-[16px] text-gray-500 ml-1">(45)</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-4 w-full md:w-auto">
                                    <div class="text-right hidden md:block">
                                        <p class="text-[14px] leading-[20px] font-medium font-bold text-gray-800">28 propostas</p>
                                        <p class="text-[12px] leading-[16px] text-gray-500">Publicado há 1 dia</p>
                                    </div>
                                    <button data-open-job class="flex-1 md:flex-none border-2 border-black text-black px-6 py-2 rounded-xl font-bold hover:bg-black hover:text-white transition-colors">
                                        Ver job
                                    </button>
                        ...
                        <div class="mt-8 flex justify-center pb-12">
                            <div class="flex items-center gap-2 bg-white rounded-lg p-1 shadow-sm border border-gray-200">
                                <button class="p-2 text-gray-400 hover:text-black disabled:opacity-50" disabled>
                                    <span class="material-symbols-outlined">chevron_left</span>
                                </button>
                                <button class="w-10 h-10 rounded-md bg-black text-white font-bold">1</button>
                                <button class="w-10 h-10 rounded-md bg-transparent text-black hover:bg-gray-100 font-bold">2</button>
                                <button class="w-10 h-10 rounded-md bg-transparent text-black hover:bg-gray-100 font-bold">3</button>
                                <span class="px-2 text-gray-400">...</span>
                                <button class="w-10 h-10 rounded-md bg-transparent text-black hover:bg-gray-100 font-bold">12</button>
                                <button class="p-2 text-black hover:bg-gray-100 rounded-md">
        ...
        // Template do Detalhe + Proposta (fica dentro da aba Trabalhos)
                  ...
                  <div class="bg-white rounded-[24px] p-8 hard-shadow flex flex-col">
                    ...
                    <div class="py-8 flex flex-col gap-4">
                      ...
                      <div class="flex flex-wrap gap-3 mt-2">
                        <span class="px-4 py-2 bg-gray-100 border border-gray-300 rounded-full font-label-md text-black">Adobe Illustrator</span>
                        <span class="px-4 py-2 bg-gray-100 border border-gray-300 rounded-full font-label-md text-black">Adobe Photoshop</span>
                        <span class="px-4 py-2 bg-gray-100 border border-gray-300 rounded-full font-label-md text-black">Design de Identidade Visual</span>
                        <span class="px-4 py-2 bg-gray-100 border border-gray-300 rounded-full font-label-md text-black">Branding</span>
                        <span class="px-4 py-2 bg-gray-100 border border-gray-300 rounded-full font-label-md text-black">Design Gráfico</span>
                      </div>
                    </div>
                    ...
                    <div class="pt-8 flex flex-col gap-4">
                      ...
                      <div class="flex flex-col gap-5 pl-5 border-l-[3px] border-orange-300">
                  ...
                  <div class="flex flex-col gap-8">
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex justify-between items-start">
                          <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col">
                              ...
                              <p class="font-label-sm text-gray-700 font-bold mt-1">Designer Sénior &amp; Branding Specialist</p>
                            </div>
                          </div>
                          <div class="text-right">
                            <p class="font-headline-sm text-black font-bold">80.000 Kz</p>
                            <p class="text-xs text-gray-500">em 5 dias</p>
                          </div>
                        </div>

                        <div class="font-body-sm text-gray-600 line-clamp-3">
                          Olá! Tenho mais de 5 anos de experiência em criação de marcas para o setor de logística. Já trabalhei com 3 empresas similares em Luanda e entendo perfeitamente o conceito de last-mile delivery que vocês procuram...
                        </div>

                        <div class="flex justify-between items-center pt-2">
                          <span class="inline-flex items-center gap-1 bg-red-50 text-red-600 text-[10px] font-bold px-2 py-1 rounded-full">
                            <span class="w-1.5 h-1.5 bg-red-600 rounded-full"></span> Multicaixa
                          </span>
                          <button class="bg-black text-white px-6 py-2 rounded-lg font-label-md text-sm font-bold hover:bg-gray-800 transition-colors">
                            Ver perfil
                          </button>
                        </div>
                      </div>
                      ...
                      <div class="bg-white rounded-[24px] p-6 hard-shadow flex flex-col gap-4">
                        <div class="flex justify-between items-start">
                          <div class="flex items-center gap-4">
                            <div class="w-14 h-14 rounded-full bg-gray-100 flex items-center justify-center font-bold text-black border border-gray-200 shrink-0">AN</div>
                            <div class="flex flex-col">
                              <div class="flex items-center gap-2">
                                <p class="font-label-md font-bold text-black">Ana Nvunda</p>
                                <span class="text-yellow-600 text-sm font-bold">⭐ 5.0</span>
                              </div>
                              <p class="text-xs text-gray-600">+45 trabalhos realizados</p>
                              <p class="font-label-sm text-gray-700 font-bold mt-1">Especialista em Identidade Visual</p>
                            </div>
                          </div>
                          <div class="text-right">
                            <p class="font-headline-sm text-black font-bold">65.000 Kz</p>
                            <p class="text-xs text-gray-500">em 7 dias</p>
                          </div>
                        </div>

                        <div class="font-body-sm text-gray-600 line-clamp-3">
                          Bom dia. O vosso projeto é extremamente interessante. Meu foco é criar sistemas visuais que sejam escaláveis e digitais-primeiro. Posso entregar os mockups de fardas e viaturas com alta fidelidade...
                        </div>
                    ...
                    <div class="flex justify-center mt-4">
                      <a class="font-label-md text-black font-bold hover:underline flex items-center gap-2" href="#">
                        Ver todas as 8 propostas <span class="material-symbols-outlined text-[18px]">arrow_downward</span>
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="lg:col-span-4 flex flex-col gap-6">
                  ...
                  <div class="bg-white rounded-[24px] p-8 hard-shadow flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-4 mt-4">
                      <div class="flex justify-between font-label-sm text-black">
                        <span class="text-gray-600">Trabalhos publicados</span>
                        <span class="font-bold">5</span>
                      </div>

                      <div class="flex flex-col gap-2">
                        <div class="flex justify-between font-label-sm text-black">
                          <span class="text-gray-600">Taxa de contratação</span>
                      ...
                      <div class="flex justify-between font-label-sm text-black">
                        ...
                        <span class="font-bold">Mai 2023</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="bg-white rounded-[24px] p-8 hard-shadow flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-5">
                      ...
                      <a class="group flex flex-col gap-1" href="#">
                        <p class="font-label-md text-black font-bold group-hover:text-blue-600 transition-colors line-clamp-2">Logo e cartões de visita para Advogado</p>
                        <p class="font-label-sm text-gray-500">KZS 25.000,00 • Há 4 dias</p>
                      </a>
                      <div class="border-t border-gray-200"></div>
                      <a class="group flex flex-col gap-1" href="#">
                        <p class="font-label-md text-black font-bold group-hover:text-blue-600 transition-colors line-clamp-2">Design de Embalagem para Produto Alimentar</p>
                        <p class="font-label-sm text-gray-500">KZS 50.000,00 • Há 1 semana</p>
                      </a>
                    </div>
                  </div>
                </div>
        ...
        function render(route, push = true, opts = {}) {
            ...
            // mantém destaque na aba Trabalhos mesmo quando estiver no detalhe
