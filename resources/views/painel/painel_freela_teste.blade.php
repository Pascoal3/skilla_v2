...
<head>
    ...
    <style>
        ...
        /* Ajuste para o estilo de menu ativo */
        .nav-item.active {
...
<nav class="hidden md:flex fixed left-0 top-0 h-full w-[280px] flex-col p-6 bg-primary-container dark:bg-primary-container z-50">
    ...
    <div class="flex-1 space-y-2">
        <!-- Botão Início (Ativo por padrão) -->
        <a class="nav-item active flex items-center gap-3 rounded-lg px-4 py-3 transition-all" href="#" onclick="navigate(event, 'home')">
            <span class="material-symbols-outlined">home</span>
            <span class="font-label-md text-label-md">Início</span>
        </a>
        <a class="nav-item flex items-center gap-3 text-on-primary-container hover:text-secondary px-4 py-3 transition-colors" href="#" onclick="navigate(event, 'trabalhos')">
            <span class="material-symbols-outlined">work</span>
            <span class="font-label-md text-label-md">Trabalhos</span>
        </a>
        <a class="nav-item flex items-center gap-3 text-on-primary-container hover:text-secondary px-4 py-3 transition-colors" href="#" onclick="navigate(event, 'propostas')">
            <span class="material-symbols-outlined">description</span>
            <span class="font-label-md text-label-md">Propostas</span>
        </a>
        <a class="nav-item flex items-center gap-3 text-on-primary-container hover:text-secondary px-4 py-3 transition-colors" href="#" onclick="navigate(event, 'mensagens')">
            <span class="material-symbols-outlined">chat</span>
            <span class="font-label-md text-label-md">Mensagens</span>
        </a>
        <a class="nav-item flex items-center gap-3 text-on-primary-container hover:text-secondary px-4 py-3 transition-colors" href="#" onclick="navigate(event, 'carteira')">
            <span class="material-symbols-outlined">account_balance_wallet</span>
            <span class="font-label-md text-label-md">Carteira</span>
        </a>
        <a class="nav-item flex items-center gap-3 text-on-primary-container hover:text-secondary px-4 py-3 transition-colors" href="#" onclick="navigate(event, 'perfil')">
            <span class="material-symbols-outlined">person</span>
            <span class="font-label-md text-label-md">Perfil</span>
        </a>
        <a class="nav-item flex items-center gap-3 text-on-primary-container hover:text-secondary px-4 py-3 transition-colors" href="#" onclick="navigate(event, 'definicoes')">
...
<main class="flex-1 w-full ml-0 md:ml-[280px] max-w-[calc(1440px-280px)] mx-auto flex flex-col min-h-screen">
    ...
    <div class="flex-1 p-container-padding-mobile md:p-container-padding-desktop flex flex-col gap-8 pb-20">
        ...
        <div id="page-home" class="page-content animate-fade-in">
            <!-- Page Header -->
        ...
        <!-- PÁGINA: TRABALHOS (Placeholder) -->
        <div id="page-trabalhos" class="page-content hidden">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
                <div>
                    <h2 class="font-headline-md text-headline-md text-black-pure mb-2">Meus Trabalhos</h2>
                    <p class="font-body-lg text-body-lg text-black-pure opacity-80">Gerencie seus projetos ativos e concluídos</p>
                </div>
            </div>
            <!-- Conteúdo futuro aqui -->
            <div class="glass-card p-8 hard-shadow text-center">
                <span class="material-symbols-outlined text-4xl text-on-tertiary-container mb-4">work</span>
                <p class="text-black-pure font-bold">Conteúdo de Trabalhos será carregado aqui</p>
            </div>
        </div>

        <!-- PÁGINA: PROPOSTAS (Placeholder) -->
        <div id="page-propostas" class="page-content hidden">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
                <div>
                    <h2 class="font-headline-md text-headline-md text-black-pure mb-2">Minhas Propostas</h2>
                    <p class="font-body-lg text-body-lg text-black-pure opacity-80">Acompanhe o status das suas candidaturas</p>
                </div>
            </div>
            <!-- Conteúdo futuro aqui -->
            <div class="glass-card p-8 hard-shadow text-center">
                <span class="material-symbols-outlined text-4xl text-on-tertiary-container mb-4">description</span>
                <p class="text-black-pure font-bold">Conteúdo de Propostas será carregado aqui</p>
            </div>
        </div>

        <!-- PÁGINA: MENSAGENS (Placeholder) -->
        <div id="page-mensagens" class="page-content hidden">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
                <div>
                    <h2 class="font-headline-md text-headline-md text-black-pure mb-2">Mensagens</h2>
                    <p class="font-body-lg text-body-lg text-black-pure opacity-80">Converse com seus clientes</p>
                </div>
            </div>
            <!-- Conteúdo futuro aqui -->
            <div class="glass-card p-8 hard-shadow text-center">
                <span class="material-symbols-outlined text-4xl text-on-tertiary-container mb-4">chat</span>
                <p class="text-black-pure font-bold">Conteúdo de Mensagens será carregado aqui</p>
            </div>
        </div>

        <!-- PÁGINA: CARTEIRA (Placeholder) -->
        <div id="page-carteira" class="page-content hidden">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
                <div>
                    <h2 class="font-headline-md text-headline-md text-black-pure mb-2">Carteira</h2>
                    <p class="font-body-lg text-body-lg text-black-pure opacity-80">Histórico de transações e saques</p>
                </div>
            </div>
            <!-- Conteúdo futuro aqui -->
            <div class="glass-card p-8 hard-shadow text-center">
                <span class="material-symbols-outlined text-4xl text-on-tertiary-container mb-4">account_balance_wallet</span>
                <p class="text-black-pure font-bold">Conteúdo de Carteira será carregado aqui</p>
            </div>
        </div>

        <!-- PÁGINA: PERFIL (Placeholder) -->
        <div id="page-perfil" class="page-content hidden">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
                <div>
                    <h2 class="font-headline-md text-headline-md text-black-pure mb-2">Meu Perfil</h2>
                    <p class="font-body-lg text-body-lg text-black-pure opacity-80">Edite suas informações públicas</p>
                </div>
            </div>
            <!-- Conteúdo futuro aqui -->
            <div class="glass-card p-8 hard-shadow text-center">
                <span class="material-symbols-outlined text-4xl text-on-tertiary-container mb-4">person</span>
                <p class="text-black-pure font-bold">Conteúdo de Perfil será carregado aqui</p>
            </div>
        </div>

        <!-- PÁGINA: DEFINIÇÕES (Placeholder) -->
        <div id="page-definicoes" class="page-content hidden">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
                <div>
                    <h2 class="font-headline-md text-headline-md text-black-pure mb-2">Definições</h2>
                    <p class="font-body-lg text-body-lg text-black-pure opacity-80">Configurações da conta</p>
                </div>
            </div>
            <!-- Conteúdo futuro aqui -->
            <div class="glass-card p-8 hard-shadow text-center">
                <span class="material-symbols-outlined text-4xl text-on-tertiary-container mb-4">settings</span>
                <p class="text-black-pure font-bold">Conteúdo de Definições será carregado aqui</p>
            </div>
        </div>
...
<script>
    ...
    function navigate(event, pageId) {
        ...
        // 3. Atualizar estilo do Menu (Sidebar)
        const navLinks = document.querySelectorAll('.nav-item');
        navLinks.forEach(link => {
            // Remove classes ativas
            link.classList.remove('active', 'bg-[#CCFF00]', 'text-black-pure', 'font-bold');
            link.classList.add('text-on-primary-container');
            
            // Verifica se este link aponta para a página atual
            // Nota: Usamos o onclick para passar o ID, mas para visualmente destacarmos,
            // precisamos saber qual botão foi clicado.
            // Uma forma simples é verificar se o href ou o onclick contêm o ID.
            if (link.getAttribute('onclick') && link.getAttribute('onclick').includes(pageId)) {
                link.classList.add('active', 'bg-[#CCFF00]', 'text-black-pure', 'font-bold');
